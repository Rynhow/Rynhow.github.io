		...
		playlist: [
			{
				...
				url: "/assets/music/Take Me Hand - DAISHI DANCE&Cécile Corbel.mp3",
				cover: "/assets/music/cover/Sacred Play Secret Place .webp",
				lrc: "",
			},
			{
				name: "Sacred Play Secret Place ",
				artist: "matryoshka",
				url: "/assets/music/Sacred Play Secret Place - matryoshka.mp3",
