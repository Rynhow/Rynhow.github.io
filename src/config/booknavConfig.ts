...
export const booknavConfig: BooknavGroup[] = [
	...
	},
	{
		...
		icon: "https://liaoxuefeng.com/index.html",
		weight: 10, // 权重，数字越大排序越靠前
			},
			{
				...
				icon: "https://www.runoob.com/wp-content/uploads/2013/06/runoob.jpeg",
				weight: 10,
			},
			{
				title: "程序员常用在线工具合集",
			...
			},
			{
				...
				desc: "提供格式转换，无损压缩等",
				icon: "https://phototool.cn/assets/images/favicon.png",
				weight: 10,
			},
		],
	},
